# 06-Footer - Tareas de Implementación
...
- [ ] Estilizar nombre "Puros Melómanos" y tagline
- [ ] Estilizar descripción de la comunidad
- [ ] Estilizar enlaces rápidos con hover effects
- [ ] Estilizar copyright y créditos
...
- [ ] Probar layout desktop (3-4 columnas)
- [ ] Probar layout tablet (2 columnas)
- [ ] Probar layout mobile (1 columna)
- [ ] Verificar que el footer se vea bien en todos los tamaños
...
- [ ] Verificar que el footer esté al final de la página
...
- Depende de todas las demás secciones (para los enlaces)
- El footer debe estar al final de la página
- Usar etiqueta semántica `<footer>`
- Diseño responsive: múltiples columnas en desktop, 1 en mobile
